...
"""
Y UNIVERSE AWARDS 2025 - Auto Scraper with GitHub Push
รันบนเครื่องของคุณ ดึงข้อมูลทุก 1 ชม. แล้ว push ขึ้น GitHub อัตโนมัติ
"""
...
# ========== ตั้งค่า ==========
CONFIG = {
    'username': 'YOUR_EMAIL',           # ← เปลี่ยนเป็น email ของคุณ
    'password': 'YOUR_PASSWORD',        # ← เปลี่ยนเป็น password ของคุณ
    'login_url': 'https://acmonlinebiz.com/yna2025/login_action.php',
    'login_page': 'https://acmonlinebiz.com/yna2025/login.php',
    'data_url': 'https://acmonlinebiz.com/yna2025/votesummary.php?tpid=4',
    'interval_hours': 1,                # ดึงข้อมูลทุกกี่ชั่วโมง
}
...
if __name__ == '__main__':
    ...
    print("🚀 Y UNIVERSE AWARDS 2025 - Auto Scraper")
    print("="*50)
    print(f"📁 เก็บข้อมูลที่: {DATA_DIR.absolute()}")
    print(f"⏰ ดึงข้อมูลทุก: {CONFIG['interval_hours']} ชั่วโมง")
